...
function StoryCard({name,profile,src}) {
    ...
    return (
        ...
        <div className="relative h-32 w-20 lg:h-56 lg:w-32  unselectable flex flex-col" >
         ...
         draggable="false"
         />
            <p className="absolute bottom-0 text-center rounded-b-3xl border-t-2 pb-1 border-gray-400 w-full opacity-0 group-hover:opacity-100 z-50 bg-white text-gray-800 font-bold text-[10px] lg:text-base ">{name}</p>
