...
function Like({id}) {
    ...
    rdb.ref("Likes").child(id).on("value",(snap)=>{
        let s = "";
      ...
      const like = () =>{
          ...
          if(Container.classList.contains("likees")){
            ...
            rdb.ref("Likes").child(id).once("value",(snapshot)=>{
    ...
    return (
               ...
               <div className="inputIcon rounded-none  rounded-bl-2xl" id=  {`like${id}`} onClick={like} onDoubleClick={null}>
